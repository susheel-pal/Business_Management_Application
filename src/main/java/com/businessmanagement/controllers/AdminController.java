...
import com.businessmanagement.basiclogics.Logic;
...
import com.businessmanagement.loginCredentials.UserLogin;
import com.businessmanagement.services.*;
...
//    public String  getSignupData(@ModelAttribute("adminSignup") AdminLogin login, Model model)
//    {
//        String email=login.getEmail();
//        String password=login.getPassword();
//        if(adminSignup.signup(email,password))
//        {
//            return "redirect:/admin/services";
//        }
//        else {
//            model.addAttribute("error", "You Already Have an Acoount");
//            return "Sign_Up";
//        }
//
//    }
